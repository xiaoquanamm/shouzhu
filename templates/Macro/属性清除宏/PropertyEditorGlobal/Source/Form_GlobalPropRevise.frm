VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Form_GlobalPropRevise 
   Caption         =   "PropertyEditorGlobal: REVISE PROP"
   ClientHeight    =   4755
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   3990
   OleObjectBlob   =   "Form_GlobalPropRevise.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "Form_GlobalPropRevise"
...
Private Sub CommandAdd_Click()
  ...
  If (SelectDoc = True) And (SelectCat = True) Then
    ...
    ListBoxContent.List(ListPosition, 1) = 2
